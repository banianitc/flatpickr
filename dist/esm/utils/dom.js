...
export function createNumberInput(inputClassName, opts, events) {
...
export var createEvent = function (name) {
    var e = document.createEvent("Event");
    e.initEvent(name, true, true);
    return e;
};
export var incrementNumInput = function (e, delta, inputElem) {
